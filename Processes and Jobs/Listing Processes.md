...
### Solve
**Flag:** `pwn.college{MfAep7uy1WBYBn7tzdxD6E-itMg.QX4MDO0wSM4AzNzEzW}`

Used ps -ef to see all the processes and found the flag file in it.

```bash
hacker@processes~listing-processes:~$ ps -ef
UID          PID    PPID  C STIME TTY          TIME CMD
root           1       0  0 12:50 ?        00:00:00 /sbin/docker-init -- /nix/var/nix/profiles/dojo-workspace/bin/dojo-i
root           7       1  0 12:50 ?        00:00:00 /run/dojo/bin/sleep 6h
root         132       1  0 12:50 ?        00:00:00 /challenge/30082-run-25080
root         135     132  0 12:50 ?        00:00:00 sleep 6h
hacker       137       0  0 12:51 pts/0    00:00:00 /nix/store/0nxvi9r5ymdlr2p24rjj9qzyms72zld1-bash-interactive-5.2p37/
hacker       143     137  0 12:51 pts/0    00:00:00 /run/dojo/bin/bash --login
hacker       152     143  0 12:51 pts/0    00:00:00 ps -ef
hacker@processes~listing-processes:~$ /challenge/30082-run-25080
Yahaha, you found me! Here is your flag:
pwn.college{MfAep7uy1WBYBn7tzdxD6E-itMg.QX4MDO0wSM4AzNzEzW}
Now I will sleep for a while (so that you could find me with 'ps').
```

### New Learnings
Learned about two types of listing processes and different components in them.
