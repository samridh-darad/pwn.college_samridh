...
### Solve
**Flag:** `pwn.college{opShqHLMHL0-3AGBxJpDjP0xkdB.QXzEjN0wSM4AzNzEzW}`

Set SUID bit to /challenge/getroot and then ran it as root then did cat /flag to get the flag.
...
# or if current dir: ./getroot
SUCCESS! You have set the suid bit on this program, and it is running as root!
Here is your shell...
root@permissions~the-suid-bit:~# cat /flag
pwn.college{opShqHLMHL0-3AGBxJpDjP0xkdB.QXzEjN0wSM4AzNzEzW}
```

### New Learnings
Learned to set SUID bit which gives anyone root access.
