...
### Solve
**Flag:** `pwn.college{M4TXq8LPLcgMFiHBJFYQrEbsqwm.QXzcjM1wSM4AzNzEzW}`

Changed the mode of /flag file to read mode for world then read it using cat /flag.

```bash
hacker@permissions~changing-permissions:~$ chmod a+r *
hacker@permissions~changing-permissions:~$ ls -l /flag
-r--r--r-- 1 root root 60 Sep 30 19:34 /flag
hacker@permissions~changing-permissions:~$ cat /flag
pwn.college{M4TXq8LPLcgMFiHBJFYQrEbsqwm.QXzcjM1wSM4AzNzEzW}
```

### New Learnings
Learned to change modes of files.
